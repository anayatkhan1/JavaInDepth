...
AnotherClass obj = new AnotherClass(); obj.showData();
obj.accessData();
...
void showData() {
System.out.println("Inside ParentClass"); System.out.println("a = " + a); System.out.println("b = " + b); System.out.println("c = " + c); System.out.println("d = " + d);
}
}
...
void accessData() {
System.out.println("Inside ChildClass"); System.out.println("a = " + a); System.out.println("b = " + b); System.out.println("c = " + c);
}
}
...
void Display() {
ParentClass obj = new ParentClass(); System.out.println(obj.a);
