...
//
//		String path = "C:\\Users\\DANISH KHAN\\git\\JavaInDepth\\JavaLearning\\src\\Unit03\\Input.txt";
...
//
//		try {
//			myObj = new FileWriter("C:\\Users\\DANISH KHAN\\git\\JavaInDepth\\JavaLearning\\src\\Unit03\\log.txt");
//		} catch (IOException e) {
...
//
	void saveLogOfProgram() throws IOException {
		...
		try {
			myObj = new FileWriter("C:\\Users\\DANISH KHAN\\git\\JavaInDepth\\JavaLearning\\src\\Unit03\\log.txt",true);
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
